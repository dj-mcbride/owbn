...
let clickxI = document.getElementById("xI").checked;
...
return [ checkUserBomb, checkUserTies, checkCompBomb, checkCompTies, checkCompSmartBomb, clickxI, clickxX, clickxC, clickxM, clickx10M, clickx100M/*, clickxMillion*/ ];
...
//get traits elements from the document
let userTraits = document.getElementById("userTraits").value;
let compTraits = document.getElementById("compTraits").value;

    if (userTraits > compTraits) {
        onWin();
        console.log("The user has more traits.");
    }

    else if (userTraits < compTraits) {
        onLoss();
        console.log("The computer has more traits.");
    }
    ...
    console.log("The player and computer have tied!")
    };
...
/*  function timesThis() { 
    ...
    rock_div.addEventListener('click', function(){
         ...
         let boxes = checkTheBoxes();
         if (boxes[5] == true) { for (x=0; x<1; x++) {game("r");}}
    else if (boxes[6] == true) { for (x=0; x<10; x++) {game("r");}}
    else if (boxes[7] == true) { for (x=0; x<100; x++) {game("r");}}
    else if (boxes[8] == true) { for (x=0; x<1000; x++) {game("r");}}
    else if (boxes[9] == true) { for (x=0; x<10000; x++) {game("r");}}
    else if (boxes[10] == true) { alert("this will crash your computer"); for (x=0; x<100000; x++) {game("r");}}
...
//  console.log("You clicked the Rock.");
    ...
    paper_div.addEventListener('click', function(){
        let boxes = checkTheBoxes();
        if (boxes[5] == true) { for (x=0; x<1; x++) {game("p");}}
   else if (boxes[6] == true) { for (x=0; x<10; x++) {game("p");}}
   else if (boxes[7] == true) { for (x=0; x<100; x++) {game("p");}}
   else if (boxes[8] == true) { for (x=0; x<1000; x++) {game("p");}}
   else if (boxes[9] == true) { for (x=0; x<10000; x++) {game("p");}}
   else if (boxes[10] == true) { alert("this will crash your computer"); for (x=0; x<100000; x++) {game("p");}}
...
//        console.log("You clicked the Paper.");
    ...
    scissors_div.addEventListener('click', function(){
        let boxes = checkTheBoxes();
        if (boxes[5] == true) { for (x=0; x<1; x++) {game("s");}}
   else if (boxes[6] == true) { for (x=0; x<10; x++) {game("s");}}
   else if (boxes[7] == true) { for (x=0; x<100; x++) {game("s");}}
   else if (boxes[8] == true) { for (x=0; x<1000; x++) {game("s");}}
   else if (boxes[9] == true) { for (x=0; x<10000; x++) {game("s");}}
   else if (boxes[10] == true) { alert("this will crash your computer"); for (x=0; x<100000; x++) {game("s");}}
...
//        console.log("You clicked the Scissors.");
    ...
    bomb_div.addEventListener('click', function(){
        let boxes = checkTheBoxes();
        if (boxes[5] == true) { for (x=0; x<1; x++) {game("b");}}
   else if (boxes[6] == true) { for (x=0; x<10; x++) {game("b");}}
   else if (boxes[7] == true) { for (x=0; x<100; x++) {game("b");}}
   else if (boxes[8] == true) { for (x=0; x<1000; x++) {game("b");}}
   else if (boxes[9] == true) { for (x=0; x<10000; x++) {game("b");}}
  else if (boxes[10] == true) { alert("this will crash your computer"); for (x=0; x<100000; x++) {game("b");}}
...
//        console.log("You clicked the Bomb.");
    ...
    random_div.addEventListener('click', function(){
        let boxes = checkTheBoxes();
        if (boxes[5] == true) { for (x=0; x<1; x++) {game(getRandomChoice());}}
   else if (boxes[6] == true) { for (x=0; x<10; x++) {game(getRandomChoice());}}
   else if (boxes[7] == true) { for (x=0; x<100; x++) {game(getRandomChoice());}}
   else if (boxes[8] == true) { for (x=0; x<1000; x++) {game(getRandomChoice());}}
   else if (boxes[9] == true) { for (x=0; x<10000; x++) {game(getRandomChoice());}}
   else if (boxes[10] == true) { alert("this will crash your computer"); for (x=0; x<100000; x++) {game(getRandomChoice());}}
