...
const KEYS = ['id', 'title', 'export', 'type', 'summary', 'version', 'src', 'encrypted', 'roles', 'methods', 'views'];
const addKeys = {};
let override = false;
...
function processTask(task) {
  ...
  taskToPush.deprecated = task.deprecated === 'true';
...
function processMethod(method) {
  ...
  methodToPush.deprecated = method.deprecated === 'true';
