...
async function viewSelection(requestObject, project) {
    ...
    log.trace(`Starting: viewCharacter.viewSelection. project : ${project} `);
    const validationResponse = new Response({
        from: 'viewSelection',
        responseCode: 400,
        message: '',
        step: 'View Item From Sheet'
    });
