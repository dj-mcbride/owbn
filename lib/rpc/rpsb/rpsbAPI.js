...
function staticRPSB(rpsbObject) {
    ...
    if (!rpsbObject.userChoice) {
        ...
        log.debug(`Update: rpsb.callForChop. value of userChoice not valid! : ${rpsbObject.userChoice}`);
    ...
    try {
        ...
        log.debug(`Update: rpsb.rpsbAPI. errorfound was found to be ${errorFound}.  Calling game`);
